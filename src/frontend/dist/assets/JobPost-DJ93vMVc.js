import { o, r as reactExports, v as vt, j as jsxRuntimeExports, L as Link } from "./index-C8Ney5nB.js";
import { u as useAuth, L as Layout, a as Briefcase, B as Button } from "./Layout-CTMNymg8.js";
...
import { c as useCreateJob, L as LoaderCircle } from "./useQueries--sm0j3R0.js";
...
function AuthGate({ onLogin }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-full bg-amber-100 dark:bg-amber-900/30 flex items-center justify-center mx-auto mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Lock, { size: 28, className: "text-amber-600 dark:text-amber-400" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold text-foreground mb-2", children: "Login Required" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mb-6", children: "You need to be logged in to post a job listing. Sign in with Internet Identity to continue." }),
...
function SuccessState({ onReset }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-full bg-amber-100 dark:bg-amber-900/30 flex items-center justify-center mx-auto mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Briefcase, { size: 28, className: "text-amber-600 dark:text-amber-400" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold text-foreground mb-2", children: "Job Posted!" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mb-6", children: "Your job listing is now live and visible to candidates." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 justify-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/jobs", "data-ocid": "job_post.view_jobs_link", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { children: "View All Jobs" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              variant: "outline",
...
function JobPost() {
  ...
  const validate = () => {
    ...
    if (!form.applyMethodValue.trim())
      errs.applyMethodValue = form.applyMethodType === "url" ? "Application URL is required" : "Email address is required";
    else if (form.applyMethodType === "email" && !/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(form.applyMethodValue))
      errs.applyMethodValue = "Enter a valid email address";
    else if (form.applyMethodType === "url" && !/^https?:\/\//.test(form.applyMethodValue))
  ...
  const handleSubmit = (e) => {
    ...
    const applyMethod = form.applyMethodType === "url" ? { url: form.applyMethodValue } : { email: form.applyMethodValue };
    createJob.mutate(
      {
      ...
      },
      {
        ...
        onError: (err) => {
          ue.error(`Failed to post job: ${err.message}`);
        }
      }
    );
  };
  ...
  if (!isAuthenticated) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(AuthGate, { onLogin: login }) });
  }
  if (submitted) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-8 max-w-2xl", "data-ocid": "job_post.page", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-3xl font-bold text-foreground flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Briefcase, { className: "text-amber-500", size: 26 }),
        "Post a Job"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mt-1", children: "Fill in the details to list your job opening" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "form",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              ...
              errors.title && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "p",
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              ...
              errors.company && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "p",
                {
                  className: "text-xs text-destructive flex items-center gap-1",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              ...
              errors.location && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "p",
                {
                  className: "text-xs text-destructive flex items-center gap-1",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "salary", children: "Salary Range (optional)" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  id: "salary",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Select,
              {
                onValueChange: (val) => set("category", val === "IT" ? { IT: null } : { NonIT: null }),
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    SelectTrigger,
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Select IT or Non-IT" })
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "IT", children: "IT (Technology)" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "NonIT", children: "Non-IT (General)" })
                  ] })
                ]
              }
            ),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-4", children: ["url", "email"].map((type) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "label",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-foreground capitalize", children: type === "url" ? "Website / URL" : "Email Address" })
                ]
              },
              type
            )) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                ...
                placeholder: form.applyMethodType === "url" ? "https://yourcompany.com/apply" : "hr@yourcompany.com",
            ...
            errors.applyMethodValue && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "p",
              {
                className: "text-xs text-destructive flex items-center gap-1",
