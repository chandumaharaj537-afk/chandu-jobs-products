...
const ApplyMethod = Variant({
  "url": Text,
  "email": Text
});
const JobCategory = Variant({ "IT": Null, "NonIT": Null });
...
const UpsertProfileRequest = Record({
  "bio": Text,
  "contactInfo": Text,
  "name": Text,
  "role": UserRole
...
Service({
  "createJob": Func([CreateJobRequest], [Job], []),
  ...
  "getProfile": Func([Principal$1], [Opt(UserProfile)], ["query"]),
  "initSeed": Func([], [], []),
  "listJobs": Func([JobFilter], [Vec(Job)], ["query"]),
  "listProducts": Func([ProductFilter], [Vec(Product)], ["query"]),
  "updateJob": Func([UpdateJobRequest], [Bool], []),
  "updateProduct": Func([UpdateProductRequest], [Bool], []),
  "upsertProfile": Func([UpsertProfileRequest], [UserProfile], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  const ApplyMethod2 = IDL2.Variant({ "url": IDL2.Text, "email": IDL2.Text });
  const JobCategory2 = IDL2.Variant({ "IT": IDL2.Null, "NonIT": IDL2.Null });
  const CreateJobRequest2 = IDL2.Record({
    "title": IDL2.Text,
    "salary": IDL2.Opt(IDL2.Text),
    "applyMethod": ApplyMethod2,
    "description": IDL2.Text,
    "company": IDL2.Text,
    "category": JobCategory2,
  ...
  const Product2 = IDL2.Record({
    "id": ProductId2,
    "title": IDL2.Text,
    "sellerPrincipal": IDL2.Principal,
    "imageUrls": IDL2.Vec(IDL2.Text),
    "listedAt": Timestamp2,
    "sellerContact": IDL2.Text,
    "description": IDL2.Text,
  ...
  const JobFilter2 = IDL2.Record({
    "category": IDL2.Opt(JobCategory2),
  ...
  const UpsertProfileRequest2 = IDL2.Record({
    "bio": IDL2.Text,
    "contactInfo": IDL2.Text,
    "name": IDL2.Text,
    "role": UserRole2
  ...
  return IDL2.Service({
    "createJob": IDL2.Func([CreateJobRequest2], [Job2], []),
    ...
    "getProfile": IDL2.Func([IDL2.Principal], [IDL2.Opt(UserProfile2)], ["query"]),
    "initSeed": IDL2.Func([], [], []),
    "listJobs": IDL2.Func([JobFilter2], [IDL2.Vec(Job2)], ["query"]),
    "listProducts": IDL2.Func([ProductFilter2], [IDL2.Vec(Product2)], ["query"]),
    "updateJob": IDL2.Func([UpdateJobRequest2], [IDL2.Bool], []),
    "updateProduct": IDL2.Func([UpdateProductRequest2], [IDL2.Bool], []),
    "upsertProfile": IDL2.Func([UpsertProfileRequest2], [UserProfile2], [])
  });
};
...
function from_candid_ApplyMethod_n10(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n11(_uploadFile, _downloadFile, value);
}
function from_candid_JobCategory_n12(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n13(_uploadFile, _downloadFile, value);
}
function from_candid_Job_n7(_uploadFile, _downloadFile, value) {
  return from_candid_record_n8(_uploadFile, _downloadFile, value);
}
function from_candid_UserProfile_n16(_uploadFile, _downloadFile, value) {
...
function from_candid_variant_n13(_uploadFile, _downloadFile, value) {
  return "IT" in value ? "IT" : "NonIT" in value ? "NonIT" : value;
}
function from_candid_variant_n19(_uploadFile, _downloadFile, value) {
  return "seller" in value ? "seller" : "employer" in value ? "employer" : "jobSeeker" in value ? "jobSeeker" : value;
}
...
function to_candid_ApplyMethod_n3(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n4(_uploadFile, _downloadFile, value);
}
function to_candid_CreateJobRequest_n1(_uploadFile, _downloadFile, value) {
  return to_candid_record_n2(_uploadFile, _downloadFile, value);
}
function to_candid_JobCategory_n5(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n6(_uploadFile, _downloadFile, value);
}
function to_candid_JobFilter_n21(_uploadFile, _downloadFile, value) {
  return to_candid_record_n22(_uploadFile, _downloadFile, value);
}
function to_candid_ProductFilter_n24(_uploadFile, _downloadFile, value) {
  return to_candid_record_n25(_uploadFile, _downloadFile, value);
}
function to_candid_UpdateJobRequest_n26(_uploadFile, _downloadFile, value) {
  return to_candid_record_n27(_uploadFile, _downloadFile, value);
}
function to_candid_UpsertProfileRequest_n28(_uploadFile, _downloadFile, value) {
...
function useListProducts(filter) {
  const { actor, isFetching } = useTypedActor();
  return useQuery({
...
export {
  ...
  ROLE_LABELS as R,
  useGetJob as a,
  getApplyMethodValue as b,
  useCreateJob as c,
  useCreateProduct as d,
  useListProducts as e,
  formatPostedAt as f,
  getSalaryText as g,
  useMyProfile as h,
  isITCategory as i,
  useUpsertProfile as j,
  backendToRole as k,
  roleToBackend as r,
  useListJobs as u
};
